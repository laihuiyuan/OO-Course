...
import net.model.AdminBean;
import net.model.RecordBO;

/**
 *
 *
 */
@WebServlet(name = "RecordBookAdmin", urlPatterns = {"/RecordokAdmin"})
public class RecordBookAdmin extends HttpServlet {
